...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO classes (class_name, section, academic_year, status) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssss", $class_name, $section, $academic_year, $status);
...
<head>
    ...
    <title>Add Class - KPRCAS Admin</title>
...
<body>
    ...
    <div class="main-content">
        <div class="mb-4">
            <h1><i class="fas fa-plus-circle text-primary"></i> Add New Class</h1>
