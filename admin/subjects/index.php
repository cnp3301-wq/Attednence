...
$query = "SELECT s.*, c.class_name, c.section, c.academic_year 
          ...
          ORDER BY c.class_name, c.section, s.subject_name ASC";
...
<head>
    ...
    <title>Manage Subjects - KPRCAS Admin</title>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-book text-primary"></i> Manage Subjects</h1>
                    ...
                    <table id="subjectsTable" class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($subject['class_id']): ?>
                                        <span class="badge badge-info">
                                            <?php echo htmlspecialchars($subject['class_name'] . ' - ' . $subject['section']); ?>
                                        </span>
                                        <br><small class="text-muted"><?php echo htmlspecialchars($subject['academic_year']); ?></small>
                                    <?php else: ?>
                                ...
                                <td>
                                    <span class="credits-badge">
                                        <i class="fas fa-star"></i> <?php echo htmlspecialchars($subject['credits']); ?> Credits
                                    </span>
                                </td>
                                <td>
                                    <?php 
                                    $desc = $subject['description'] ?? '';
                                    echo $desc ? htmlspecialchars(substr($desc, 0, 50)) . (strlen($desc) > 50 ? '...' : '') : '<em class="text-muted">No description</em>';
                                    ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <a href="delete.php?id=<?php echo $subject['id']; ?>" 
                                       ...
                                       title="Delete"
                                       onclick="return confirm('Are you sure you want to delete this subject? This will also remove teacher assignments.');">
