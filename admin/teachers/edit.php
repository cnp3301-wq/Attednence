...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name) || empty($email) || empty($username)) {
        ...
        if ($check_stmt->get_result()->num_rows > 0) {
            ...
            if ($check_stmt->get_result()->num_rows > 0) {
                ...
                // Update teacher
                $stmt = $conn->prepare("UPDATE users SET name = ?, email = ?, username = ?, phone = ?, department = ?, designation = ?, status = ? WHERE id = ?");
                $stmt->bind_param("sssssssi", $name, $email, $username, $phone, $department, $designation, $status, $id);
    ...
    // Refresh teacher data if validation failed
...
<head>
    ...
    <title>Edit Teacher - KPRCAS Admin</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <h1><i class="fas fa-user-edit text-warning"></i> Edit Teacher</h1>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-user-edit"></i> Update Teacher Information</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="full_name" name="full_name" 
                                       required value="<?php echo htmlspecialchars($teacher['name']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" id="email" name="email" 
                                       required value="<?php echo htmlspecialchars($teacher['email']); ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="username" name="username" 
                                       required value="<?php echo htmlspecialchars($teacher['username']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="designation" name="designation" 
                                       value="<?php echo htmlspecialchars($teacher['designation'] ?? ''); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> To reset the password, use the "Reset Password" button from the teachers list.
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="reset_password.php?id=<?php echo $teacher['id']; ?>" class="btn btn-info">
