...
// Split name into first_name and last_name for form display
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $new_class_id = !empty($_POST['class_id']) ? intval($_POST['class_id']) : null;
    ...
    if (empty($roll_number) || empty($first_name) || empty($last_name) || empty($email)) {
        ...
        $check_stmt = $conn->prepare("SELECT id FROM students WHERE roll_number = ? AND id != ?");
        $check_stmt->bind_param("si", $roll_number, $id);
        $check_stmt->execute();
        if ($check_stmt->get_result()->num_rows > 0) {
            ...
            if ($check_stmt->get_result()->num_rows > 0) {
                ...
                // Update student
                $stmt = $conn->prepare("UPDATE students SET roll_number = ?, name = ?, email = ?, phone = ?, class_id = ?, admission_date = ?, date_of_birth = ?, address = ?, status = ? WHERE id = ?");
                $stmt->bind_param("ssssissssi", $roll_number, $name, $email, $phone, $new_class_id, $admission_date, $date_of_birth, $address, $status, $id);
                
                if ($stmt->execute()) {
                    // Update student counts if class changed
                    if ($old_class_id != $new_class_id) {
                        if ($old_class_id) {
                            updateStudentCount($old_class_id); // Decrement old class
                        }
                        if ($new_class_id) {
                            updateStudentCount($new_class_id); // Increment new class
                        }
                    }
    ...
    // Refresh student data if validation failed
    $stmt = $conn->prepare("SELECT * FROM students WHERE id = ?");
    $stmt->bind_param("i", $id);
    $stmt->execute();
    $student = $stmt->get_result()->fetch_assoc();
...
<head>
    ...
    <title>Edit Student - KPRCAS Admin</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <h1><i class="fas fa-user-edit text-warning"></i> Edit Student</h1>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-user-edit"></i> Update Student Information</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="roll_number" name="roll_number" 
                                       required value="<?php echo htmlspecialchars($student['roll_number']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" id="email" name="email" 
                                       required value="<?php echo htmlspecialchars($student['email']); ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="first_name" name="first_name" 
                                       required value="<?php echo htmlspecialchars($student['first_name']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="last_name" name="last_name" 
                                       required value="<?php echo htmlspecialchars($student['last_name']); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <small class="text-muted">Changing class will update student counts automatically</small>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" class="form-control" id="admission_date" name="admission_date" 
                                       required value="<?php echo htmlspecialchars($student['admission_date']); ?>">
                            </div>
                        </div>
                    </div>
